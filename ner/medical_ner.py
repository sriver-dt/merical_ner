...
from task.task_medical.ner_dataset import CustomDataloader
...
DATA_PATH = Path(os.path.join(FILE_ROOT_DIR, '../datas/medical'))
BERT_PATH = Path(r'C:\Users\du\.cache\huggingface\hub\hub\bert-base-chinese')


def training():
    save_model_dir = os.path.join(FILE_ROOT_DIR, '../output/medical')
